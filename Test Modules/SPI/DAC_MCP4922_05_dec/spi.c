...
U8 spi_send_byte(U16 data)
{
  ...
  uart0_send_byte('A');
  uart0_send_byte((temp & 0x0f) + 0x37);
  uart0_send_byte(((temp>> 4) & 0x0f) + 0x37);
  uart0_send_byte(((temp>> 8) & 0x0f) + 0x37);
  uart0_send_byte(((temp>> 12)& 0x0f) + 0x30);
  uart0_send_byte('B');
