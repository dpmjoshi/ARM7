...
{   
   ...
   if(Uc_recv_data[Uc_byte_count] == '\r')
    {
       Uc_byte_count++;
	   Uc_recv_data[Uc_byte_count] = '\n';
	   Uc_byte_count = 0;
	   //uart0_send_byte('\n');
    }
   else
   ...
   //uart0_send_byte(Uc_recv_data[Uc_byte_count]);
 VICVectAddr = 0x00;
}
//***************************************************
...
{
  clrscr();
  lcd_line1_disp("ZigBee Test",0);
  lcd_line4_disp("Press 1 to continue",0);
}
//***************************************************
